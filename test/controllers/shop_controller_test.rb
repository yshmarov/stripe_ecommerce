...
class ShopControllerTest < ActionDispatch::IntegrationTest
  test "add to cart" do
    ...
    assert_equal 599, order.total_amount
    assert_equal 599, order.order_items.first.total_amount
    assert_equal 599, order.order_items.first.unit_amount
    ...
    assert_equal 698, order.total_amount
    assert_equal 599, order.order_items.first.total_amount
    assert_equal 599, order.order_items.first.unit_amount
    assert_equal 99, order.order_items.second.unit_amount
    assert_equal 99, order.order_items.second.total_amount
    ...
    assert_equal 797, order.total_amount
    assert_equal 599, order.order_items.first.total_amount
    assert_equal 599, order.order_items.first.unit_amount
    assert_equal 99, order.order_items.second.unit_amount
    assert_equal 198, order.order_items.second.total_amount
  end
